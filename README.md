...
Nimbus uses on-map selection for origin and destination locations (Geocoding currently not supported). Users can choose between travel modes: Driving, Cycling, and Walking. This adjusts the ETA of the route accordingly by estimating the average speed of the user.
